# Jeszcze jedna wersja, aby pokazać względnie nową możliwość Pythona: przypisanie typu := , działające jako wyrażenie, do użycia w if lub while.
...
# Ostatecznie w Pythonie 3.8 to wprowadzono, ale jako nowy operator.
